...
sxtTools::setwd_project()
setwd("data/shake_study/lipidomics_data_anlaysis/invidual_variation")
...
names(lipidomics_icc) <- variable_id
save(lipidomics_icc, file = "lipidomics_icc")
...
names(lipidomics_iqr) <- variable_id
save(lipidomics_iqr, file = "lipidomics_iqr")

load("lipidomics_iqr")

plot(lipidomics_icc, lipidomics_iqr)
